...
public class DefaultSpellChecker implements ISpellChecker {
	...
	public void execute(final ISpellEventListener listener, final ISpellCheckIterator iterator) {
		final boolean ignoreDigits= fPreferences.getBoolean(TextSpellingPlugin.PREF_IGNORE_DIGITS);	
		final boolean ignoreMixed= fPreferences.getBoolean(TextSpellingPlugin.PREF_IGNORE_MIXED);
		final boolean ignoreSentence= fPreferences.getBoolean(TextSpellingPlugin.PREF_IGNORE_SENTENCE);
		final boolean ignoreUpper= fPreferences.getBoolean(TextSpellingPlugin.PREF_IGNORE_UPPER);
		final boolean ignoreURLS= fPreferences.getBoolean(TextSpellingPlugin.PREF_IGNORE_URLS);
		final boolean ignoreNonLetters= fPreferences.getBoolean(TextSpellingPlugin.PREF_IGNORE_NONLETTERS);
		final boolean ignoreSingleLetters= fPreferences.getBoolean(TextSpellingPlugin.PREF_IGNORE_SINGLE);
		final int problemsThreshold= 1000;
