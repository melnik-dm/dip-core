...
/**
* Класс InlineParserImpl из библиотеки commonmark (https://opensource.org/license/BSD-2-Clause)
* https://mvnrepository.com/artifact/org.commonmark/commonmark
* 
* Изменен конструктор (добавляется парсер MdHtmlInlineParser)
*/
...
public class MdInlineParserImpl implements InlineParser, InlineParserState {
    ...
    public MdInlineParserImpl(InlineParserContext inlineParserContext) {
        ...
        this.inlineParsers.put('<', Arrays.asList(new AutolinkInlineParser(), new MdHtmlInlineParser()));
    ...
    private List<? extends Node> parseInline() {
        ...
        List<Node> result =  Collections.singletonList(parseText());
        return result;
    }
