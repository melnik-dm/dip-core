...
import ru.dip.ui.action.open.OpenAction;
import ru.dip.ui.action.open.OpenAndExpand;
import ru.dip.ui.action.open.OpenEditorActionGroup;

public class OpenAtionProvider extends CommonActionProvider {
	...
	public void fillContextMenu(IMenuManager menu) {
		if (fInViewPart) {
			IAction openAction = fOpenGroup.getOpenAction();
		...
		if (workbenchSite != null) {
			if (workbenchSite.getPart() != null && workbenchSite.getPart() instanceof IViewPart) {
				...
				if (site.getStructuredViewer() instanceof TreeViewer)
					fOpenAndExpand = new OpenAndExpand(workbenchSite.getSite(), (OpenAction) fOpenGroup.getOpenAction(),
