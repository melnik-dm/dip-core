...
public class ImportFolderAfterAction extends DocumentAction  implements CancelledDocumentAction  {

	private ImportResult fResult;
	
	public ImportFolderAfterAction(KTableComposite tableComposite) {
		super(tableComposite);
		setText(Messages.ImportFolderAfterAction_Name);
	}
	
	public ImportFolderAfterAction(ImportFolderAfterAction original) {
		super(original.fTableComposite);
		fResult = original.fResult;
	}
	
	public ImportFolderAfterAction copy() {
		return new ImportFolderAfterAction(this);
	}
	...
	private void doAction() {
		fResult = fTableComposite.doImportAfterFolder();
	}
