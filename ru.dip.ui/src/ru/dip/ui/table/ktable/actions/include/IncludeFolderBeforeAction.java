...
public class IncludeFolderBeforeAction extends DocumentAction implements CancelledDocumentAction {

	private IncludeFolderResult fResult;
	
	public IncludeFolderBeforeAction(KTableComposite tableComposite) {
		super(tableComposite);
		setText(Messages.IncludeFolderBeforeAction_Name);
	}
	
	public IncludeFolderBeforeAction(IncludeFolderBeforeAction original) {
		super(original.fTableComposite);
		fResult = original.fResult;
	}
	
	private IncludeFolderBeforeAction copy() {
		return new IncludeFolderBeforeAction(this);
	}
	...
	public void doAction() {
		fResult = fTableComposite.doIncludeBefore();	
	}
