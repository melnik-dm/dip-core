...
public class ImportFileAfterAction extends DocumentAction implements CancelledDocumentAction {

	private ImportResult fResult;
	
	public ImportFileAfterAction(KTableComposite tableComposite) {
		super(tableComposite);
		setText(Messages.ImportFileAfterAction_Name);
	}
	
	public ImportFileAfterAction(ImportFileAfterAction original) {
		super(original.fTableComposite);
		fResult = original.fResult;
	}
	
	public ImportFileAfterAction copy() {
		return new ImportFileAfterAction(this);
	}
	...
	private void doAction() {
		fResult = fTableComposite.doImportAfterFile();
	}
