...
public class ImportFolderBeforeAction extends DocumentAction implements CancelledDocumentAction  {

	private ImportResult fResult;
	
	public ImportFolderBeforeAction(KTableComposite tableComposite) {
		super(tableComposite);
		setText(Messages.ImportFolderBeforeAction_Name);
	}
	
	public ImportFolderBeforeAction(ImportFolderBeforeAction original) {
		super(original.fTableComposite);
		fResult = original.fResult;
	}
	
	public ImportFolderBeforeAction copy() {
		return new ImportFolderBeforeAction(this);
	}
	...
	private void doAction() {
		fResult = fTableComposite.doImportBeforeFolder();
	}
