...
public class OrientationVerticalAction extends DocumentAction implements CancelledDocumentAction {

	private OrientationResult fResult;

	public OrientationVerticalAction(KTableComposite tableComposite) {
		super(tableComposite);
		setText(Messages.VerticalOrientationAction_Name);
	}
	
	public OrientationVerticalAction(OrientationVerticalAction original) {
		super(original.fTableComposite);
		fResult = original.fResult;
	}
	
	public OrientationVerticalAction copy() {
		return new OrientationVerticalAction(this);
	}
	...
	@Override
	public void run() {
		fResult = fTableComposite.doSetHorizontalOrientation(false);
		if (fResult != null) {		
