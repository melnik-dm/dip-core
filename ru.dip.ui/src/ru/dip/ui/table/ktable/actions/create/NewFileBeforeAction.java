...
public class NewFileBeforeAction extends DocumentAction implements CancelledDocumentAction {

	private CreateFileResult fResult;
		
	public NewFileBeforeAction(KTableComposite tableComposite) {
		super(tableComposite);
		setText(Messages.NewFileBeforeAction_Name);
	}
	
	private NewFileBeforeAction(NewFileBeforeAction original) {
		super(original.fTableComposite);
		fResult = original.fResult;
	}
	
	private NewFileBeforeAction copy() {
		return new NewFileBeforeAction(this);
	}
	...
	public void doAction() {
		fResult = fTableComposite.doAddNewFileBefore();	
	}
