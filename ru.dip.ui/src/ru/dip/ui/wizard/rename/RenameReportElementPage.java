...
public class RenameReportElementPage extends WizardPage implements IRenamePage {

	public static final String EXTENSION = ".report"; //$NON-NLS-1$
	...
	protected RenameReportElementPage(String pageName, DipElement dipElement) {
		super(pageName);
		setTitle(pageName);
		setDescription(Messages.RenameReportElementPage_Description);
	...
	private String getOldName(){
		...
		if (name.endsWith(".report")){ //$NON-NLS-1$
	...
	public void createControl(Composite parent) {
		...
		fNewFilePath = new EntryTextComposite(composite, Messages.RenameReportElementPage_NewNameTitle);
		...
		extensionLabel.setText(".report  "); //$NON-NLS-1$
	...
	public String getNewName(){
		return fNewFilePath.getValue() + EXTENSION;
	}
